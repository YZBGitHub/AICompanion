...
const ZH_TEXT = {
  ...
  process: {
    ...
    filters: {
      subCategories: { platform: '平台行为数据', course: '课程任务数据', ai: 'AI助手数据' },
      ...
      metrics_platform: { login: '用户登陆平台次数', duration: '平台在线时长', question_count: '平台提问总次数' },
      metrics_course: {
        submit: '提交报告数量',
        duration: '任务学习总时长',
        practice_duration: '任务-实验实训学习时长',
        reading_duration: '任务-图文学习时长',
        video_duration: '任务-视频学习时长',
        quiz_duration: '任务-习题与测试学习时长',
        completion_count: '任务-完成数量'
      },
      metrics_ai: { qa_count: '课程技能助手问答次数', qa_duration: '课程技能助手问答时间', session_count: '课程技能助手会话数量', open_count: '课程技能助手打开次数' },
...
const EN_TEXT = {
  ...
  process: {
    ...
    filters: {
      ...
      metrics_platform: { login: 'Platform login count', duration: 'Platform online time', question_count: 'Total platform questions' },
      metrics_course: {
        submit: 'Reports submitted',
        duration: 'Total task learning time',
        practice_duration: 'Task - Lab and practical training time',
        reading_duration: 'Task - Text and image learning time',
        video_duration: 'Task - Video learning time',
        quiz_duration: 'Task - Exercise and test learning time',
        completion_count: 'Task - Completion count'
      },
      metrics_ai: { qa_count: 'Course skill assistant Q&A count', qa_duration: 'Course skill assistant Q&A time', session_count: 'Course skill assistant session count', open_count: 'Course skill assistant open count' },
